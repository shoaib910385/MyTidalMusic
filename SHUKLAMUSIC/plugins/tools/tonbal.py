...
async def bal_command(client, message: Message):
    ...
    try:
        ...
        try:
            ...
            font_title = ImageFont.truetype(FONT_PATH, 225)
            font_values = ImageFont.truetype(FONT_PATH, 140)
        except Exception as e:
        ...
        draw.text((img_width / 2, 100), title_text, font=font_title, fill=WHITE, anchor="mt")
